...
class PangkatSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            ...
            ['nama_pangkat' => 'Juru Muda Tk. 1', 'golongan' => 'I/b'],
            ['nama_pangkat' => 'Juru', 'golongan' => 'I/c'],
            ['nama_pangkat' => 'Juru Tk. 1', 'golongan' => 'I/d'],

            ['nama_pangkat' => 'Pengatur Muda', 'golongan' => 'II/a'],
            ['nama_pangkat' => 'Pengatur Muda Tk. 1', 'golongan' => 'II/b'],
            ['nama_pangkat' => 'Pengatur', 'golongan' => 'II/c'],
            ['nama_pangkat' => 'Pengatur Tk. 1', 'golongan' => 'II/d'],

            ['nama_pangkat' => 'Penata Muda', 'golongan' => 'III/a'],
            ['nama_pangkat' => 'Penata Muda Tk. 1', 'golongan' => 'III/b'],
            ['nama_pangkat' => 'Penata', 'golongan' => 'III/c'],
            ['nama_pangkat' => 'Penata Tk. 1', 'golongan' => 'III/d'],

            ['nama_pangkat' => 'Pembina', 'golongan' => 'IV/a'],
            ['nama_pangkat' => 'Pembina Tk. 1', 'golongan' => 'IV/b'],
