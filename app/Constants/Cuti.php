...
class Cuti
{
    ...
    public const STATUS_COLOR = [
        ...
        'Diterima' => 'bg-success-soft text-fg-success-strong ring-1 ring-inset ring-success-subtle',
        ...
        'Ditolak' => 'bg-danger-soft text-fg-danger-strong ring-1 ring-inset ring-danger-subtle',
    ];
