...
@section('content')
    {{-- Header --}}
    <x-ui.header :back="route('admin.pegawai.show', $pegawaiId)">Riwayat Pangkat</x-ui.header>

    {{-- BreadCrumb --}}
    <x-ui.breadcrumb :breadcrumbs="Breadcrumbs::generate('admin.riwayat-pangkat.index', $pegawaiId)" />
    ...
    <section>
        ...
        <div class="bg-white shadow-sm rounded-bl-lg rounded-br-lg ">
            ...
            <div class="ml-auto w-fit mb-2 p-6">
                ...
                {{-- Create Button --}}
                <a href="{{ route('admin.riwayat-pangkat.create', $pegawaiId) }}"
