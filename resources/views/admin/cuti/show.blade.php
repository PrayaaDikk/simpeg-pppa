    ...
    <section class="space-y-6">
        ...
        <x-ui.detail-section>
            ...
            <x-ui.detail-block title="Informasi Identitas Pegawai">
                ...
                <x-ui.detail-item title="Tanggal Lahir" :value="$pegawai->tgl_lahir" />
            </x-ui.detail-block>

            <x-ui.detail-block title="Informasi Identitas Pegawai">
                <x-ui.detail-item title="Jenis Cuti" :value="$cuti->jenis_cuti" />
                <x-ui.detail-item title="Tanggal Mulai Cuti" :value="$cuti->tanggal_mulai" />
                <x-ui.detail-item title="Tanggal Selesai Cuti" :value="$cuti->tanggal_selesai" />
                <x-ui.detail-item title="Lama Cuti" :value="$cuti->lama_cuti . ' hari'" />
                <x-ui.detail-item title="Alasan Cuti" :value="$cuti->alasan_cuti" />
                <x-ui.detail-item title="Alamat Selama Cuti" :value="$cuti->alamat_cuti" />
                <x-ui.detail-item title="No. Telepon" :value="$cuti->no_telp" />

                <div class="md:col-span-3">
                    <x-ui.detail-item title="Catatan Tambahan" :value="$cuti->catatan_cuti" />
                </div>
            </x-ui.detail-block>
            ...
            <div class="flex items-center flex-wrap justify-end max-xs:justify-start gap-3 pt-6 border-t border-gray-200">
                ...
                <x-ui.delete-button :action="route('admin.cuti.destroy', $cuti)" title="Hapus Data Cuti"
                    message="Apakah Anda yakin ingin menghapus data cuti ini?" confirmText="Ya, hapus"
