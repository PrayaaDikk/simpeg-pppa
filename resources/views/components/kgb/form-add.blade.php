@props(['golonganOptions'])

<form class="max-w-5xl mx-auto"
      action="{{ route('kgb.store') }}"
      method="POST"
    ...
    {{-- KGB Berikutnya (Full Width) --}}
    <x-ui.input 
        type="date"
        name="kgb_berikutnya"
        label="KGB Berikutnya"
        :value="old('kgb_berikutnya')"
        class="mb-6"
        required>
    ...
    {{-- Golongan --}}
    <x-input-form-block>
        <x-ui.select name="golongan_lama"
                    label="Golongan Lama"
                    :options="$golonganOptions"
                    :selected="old('golongan_lama')" />

        <x-ui.select name="golongan_baru"
                    label="Golongan Baru"
                    :options="$golonganOptions"
                    :selected="old('golongan_baru')"
                    required />
    </x-input-form-block>
