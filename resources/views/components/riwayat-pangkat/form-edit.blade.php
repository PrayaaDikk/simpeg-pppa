...
<form class="max-w-5xl mx-auto"
    action="{{ route(auth()->user()->routePrefix() . 'riwayat-pangkat.update', $riwayatPangkat->id) }}" method="POST"
    ...
    <div class="flex items-center gap-3">
        ...
        <a href="{{ route(auth()->user()->routePrefix() . 'riwayat-pangkat.show', $riwayatPangkat) }}"
