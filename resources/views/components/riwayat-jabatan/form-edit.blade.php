...
<form class="max-w-5xl mx-auto"
    action="{{ route(auth()->user()->routePrefix() . 'riwayat-jabatan.update', $riwayatJabatan->id) }}" method="POST"
    ...
    <div class="flex items-center gap-3">
        ...
        <a href="{{ route(auth()->user()->routePrefix() . 'riwayat-jabatan.show', $riwayatJabatan) }}"
