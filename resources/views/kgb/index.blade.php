...
@section('content')
    {{-- Header --}}
    <x-ui.header>Informasi Kenaikan Gaji Berkala Pegawai DP3A Kota Kendari</x-ui.header>

    {{-- BreadCrumb --}}
    <x-ui.breadcrumb :breadcrumbs="Breadcrumbs::generate(auth()->user()->routePrefix() . 'kgb.index')" />
        ...
        <div class="bg-white shadow-sm rounded-lg ">
            <div class="flex items-center justify-between flex-wrap mb-2 p-6 gap-4">
                ...
                <div class="inline-flex items-center justify-between gap-2 flex-wrap">
                    <form method="GET" action="{{ route(auth()->user()->routePrefix() . 'kgb.index') }}" id="filterForm"
                        ...
                        <x-ui.dropdown-filter title="Filter">
                            ...
                            <div class="flex items-center gap-2 pt-3 border-t border-default-medium">
                                ...
                                <a href="{{ route(auth()->user()->routePrefix() . 'pegawai.index') }}"
                ...
                @if (auth()->user()->role !== 'admin')
                    <a href="{{ route(auth()->user()->routePrefix() . 'kgb.create', auth()->user()->id) }}"
