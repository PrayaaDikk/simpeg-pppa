...
@section('content')
    {{-- Header --}}
    <x-ui.header :back="route(auth()->user()->routePrefix() . 'pegawai.show', $pegawaiId)">Riwayat Jabatan</x-ui.header>
    ...
    <section>
        ...
        <div class="bg-white shadow-sm rounded-bl-lg rounded-br-lg ">
            ...
            <div class="ml-auto w-fit mb-2 p-6">
                ...
                {{-- Create Button --}}
                <a href="{{ route(auth()->user()->routePrefix() . 'riwayat-jabatan.create', $pegawaiId) }}"
